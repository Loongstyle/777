...
function main() {
    ...
    //设置文章篇数和时长
    aCount = 7 - myScores["阅读文章"][0].toString();//至少一篇
    aTime = parseInt((6 - myScores["文章学习时长"][0].toString()) * 120 / aCount) + 15;//至少15s
    //设置视频个数
    vCount = 6 - myScores["视听学习"][0].toString();//不用多学
    //设置和广播时长
    rTime = (6 - myScores["视听学习时长"][0].toString()) * 180;

    console.log("还需学习");
    console.log("文章篇数: " + (6 - myScores["阅读文章"][0].toString()) + "篇");
    console.log("文章学习时长: " + (6 - myScores["文章学习时长"][0].toString()) * 2 + "分钟");
    console.log("视频个数: " + vCount + "个");
    console.log("视听学习时长:" + (6 - myScores["视听学习时长"][0].toString()) * 3 + "分钟");
